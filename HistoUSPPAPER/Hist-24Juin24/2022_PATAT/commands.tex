...
\newcommand{\CBCTT}{\acronym{CBCTT}}
\newcommand{\ETT}{\acronym{ETT}}
\newcommand{\MPP}{\acronym{MPP}}
\newcommand{\PECTT}{\acronym{PECTT}}
\newcommand{\TAP}{\acronym{TAP}}
\newcommand{\UCTP}{\acronym{UCTP}}
...
\newcommand{\STUDENT}{U}
\newcommand{\GROUP}{G}
\newcommand{\TEACHER}{L} % Teacher (T) -> Lecturer (L)
\newcommand{\ROOM}{R}
...
\newcommand{\SAMETEACHERS}{same\_lecturers} % same\_teachers -> same\_lecturers
...
\newcommand{\TEACHERDISTRIBUTION}{lecturer\_distribution} % teacher\_distribution -> lecturer\_distribution
...
\newcommand{\xteacher}{\text{x\_lecturers}} %x\_teachers -> x\_lecturers
