...
public class SolutionAB {
	...
	public SolutionAB(ArrayList<Integer> x_slot,ArrayList<SessionRooms> x_rooms, ArrayList<SessionTeachers> x_teachers) {
		this.x_slot = x_slot;
		this.x_rooms = x_rooms;
		this.x_teachers = x_teachers;
	}//FinMehod
	
	public SolutionAB(SolutionGA ga) {
		copySolution(ga);
	}//FinMehod
